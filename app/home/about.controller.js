...
//=====================================================================================================================================================================================
//============================= END OF THE JAVASCRIPT, START OF THE ANGULAR BELOW =====================================================================================================
//=====================================================================================================================================================================================
      {syntax: "ng-app", language:"Angular", def:"Defines the root element of an application."},
      {syntax: "ng-bind", language:"Angular", def:"Binds the content of an HTML element to application data."},
      {syntax: "ng-bind-html", language:"Angular", def:"Binds the innerHTML of an HTML element to application data, and also removes dangerous code from the HTML string."},
      {syntax: "ng-bind-template", language:"Angular", def:"Specifies that the text content should be replaced with a template."},
      {syntax: "ng-blur", language:"Angular", def:"Specifies a behavior on blur events."},
      {syntax: "ng-change", language:"Angular", def:"Specifies an expression to evaluate when content is being changed by the user."},
      {syntax: "ng-checked", language:"Angular", def:"Specifies if an element is checked or not."},
      {syntax: "ng-class", language:"Angular", def:"Specifies CSS classes on HTML elements."},
      {syntax: "ng-class-even", language:"Angular", def:"Same as ng-class, but will only take effect on even rows."},
      {syntax: "ng-class-odd", language:"Angular", def:"Same as ng-class, but will only take effect on odd rows."},
      {syntax: "ng-click", language:"Angular", def:"Specifies an expression to evaluate when an element is being clicked."},
      {syntax: "ng-cloak", language:"Angular", def:"Prevents flickering when your application is being loaded."},
      {syntax: "ng-controller", language:"Angular", def:"Defines the controller object for an application."},
      {syntax: "ng-copy", language:"Angular", def:"Specifies a behavior on copy events."},
      {syntax: "ng-csp", language:"Angular", def:"Changes the content security policy."},
      {syntax: "ng-cut", language:"Angular", def:"Specifies a behavior on cut events"},
      {syntax: "ng-dblclick", language:"Angular", def:"Specifies a behavior on double-click events."},
      {syntax: "ng-disabled", language:"Angular", def:"Specifies if an element is disabled or no"},
      {syntax: "ng-focus", language:"Angular", def:"Specifies a behavior on focus events."},
      {syntax: "ng-form", language:"Angular", def:"Specifies an HTML form to inherit controls from."},
      {syntax: "ng-hide", language:"Angular", def:"Hides or shows HTML elements."},
      {syntax: "ng-href", language:"Angular", def:"Specifies a url for the <a> element."},
      {syntax: "ng-if", language:"Angular", def:"Removes the HTML element if a condition is false."},
      {syntax: "ng-include", language:"Angular", def:"Includes HTML in an application."},
      {syntax: "ng-init	", language:"Angular", def:"Defines initial values for an application."},
      {syntax: "ng-jq", language:"Angular", def:"Specifies that the application must use a library, like jQuery."},
      {syntax: "ng-keydown", language:"Angular", def:"Specifies a behavior on keydown events."},
      {syntax: "ng-keypress", language:"Angular", def:"Specifies a behavior on keypress events"},
      {syntax: "ng-keyup", language:"Angular", def:"Specifies a behavior on keyup events."},
      {syntax: "ng-list", language:"Angular", def:"Converts text into a list (array)."},
      {syntax: "ng-model", language:"Angular", def:"Binds the value of HTML controls to application data."},
      {syntax: "ng-model-options", language:"Angular", def:"Specifies how updates in the model are done."},
      {syntax: "ng-mousedown", language:"Angular", def:"Specifies a behavior on mousedown events."},
      {syntax: "ng-mouseenter", language:"Angular", def:"Specifies a behavior on mouseenter events."},
      {syntax: "ng-mouseleave", language:"Angular", def:"Specifies a behavior on mouseleave events."},
      {syntax: "ng-mouseleave	", language:"Angular", def:"Specifies a behavior on mouseleave events."},
      {syntax: "ng-mousemove", language:"Angular", def:"Specifies a behavior on mousemove events."},
      {syntax: "ng-mouseup", language:"Angular", def:"Specifies a behavior on mouseup events."},
      {syntax: "ng-non-bindable", language:"Angular", def:"Specifies that no data binding can happen in this element, or it's children."},
      {syntax: "ng-open", language:"Angular", def:"Specifies the open attribute of an element."},
      {syntax: "ng-options", language:"Angular", def:"Specifies <options> in a <select> list"},
      {syntax: "ng-paste", language:"Angular", def:"Specifies a behavior on paste events."},
      {syntax: "ng-pluralize", language:"Angular", def:"Specifies a message to display according to en-us localization rules."},
      {syntax: "ng-readonly", language:"Angular", def:"Specifies the readonly attribute of an element."},
      {syntax: "ng-repeat", language:"Angular", def:"Defines a template for each data in a collection."},
      {syntax: "ng-required", language:"Angular", def:"Specifies the required attribute of an element."},
      {syntax: "ng-selected", language:"Angular", def:"Specifies the selected attribute of an element"},
      {syntax: "ng-show", language:"Angular", def:"Shows or hides HTML elements"},
      {syntax: "ng-src", language:"Angular", def:"Specifies the src attribute for the <img> element."},
      {syntax: "ng-srcset", language:"Angular", def:"Specifies the srcset attribute for the <img> element"},
      {syntax: "ng-style", language:"Angular", def:"Specifies the style attribute for an element."},
      {syntax: "ng-submit", language:"Angular", def:"Specifies expressions to run on onsubmit events."},
      {syntax: "ng-switch", language:"Angular", def:"Specifies a condition that will be used to show/hide child elements."},
      {syntax: "ng-transclude", language:"Angular", def:"Specifies a point to insert transcluded elements."},
      {syntax: "ng-value", language:"Angular", def:"Specifies the value of an input element."},
      {syntax: "a", language:"Angular", def:"AngularJS modifies the <a> element's default behaviors."},
      {syntax: "form", language:"Angular", def:"AngularJS modifies the <form> element's default behaviors."},
      {syntax: "input", language:"Angular", def:"AngularJS modifies the <input> element's default behaviors."},
      {syntax: "script", language:"Angular", def:"AngularJS modifies the <script> element's default behaviors."},
      {syntax: "select", language:"Angular", def:"AngularJS modifies the <select> element's default behaviors."},
      {syntax: "textarea", language:"Angular", def:"AngularJS modifies the <textarea> element's default behaviors."},
      {syntax: "currency", language:"Angular", def:"Format a number to a currency format."},
      {syntax: "date", language:"Angular", def:"Format a date to a specified format."},
      {syntax: "filter", language:"Angular", def:"Select a subset of items from an array."},
      {syntax: "json", language:"Angular", def:"Format an object to a JSON string."},
      {syntax: "limitTo", language:"Angular", def:"Limits an array, or a string, into a specified number of elements/characters."},
      {syntax: "lowercase", language:"Angular", def:"Format a string to lower case."},
      {syntax: "number", language:"Angular", def:"Format a number to a string."},
      {syntax: "orderBy", language:"Angular", def:"Orders an array by an expression."},
      {syntax: "uppercase", language:"Angular", def:"Format a string to upper case."},
      {syntax: "$scope", language:"Angular", def:"$scope is the application object (the owner of application variables and functions)"},
      {syntax: "$dirty", language:"Angular", def:"Used to say that the field has been modified"},
      {syntax: "$invalid", language:"Angular", def:"Used to say that the field content is not valid"},
      {syntax: "$error", language:"Angular", def:"Used to say that the field has an error."},
      {syntax: "$untouched", language:"Angular", def:"Used to say that the field has not been touched yet."},
      {syntax: "$touched", language:"Angular", def:"Used to say that the field has been touched."},
      {syntax: "$pristine", language:"Angular", def:"Used to say that the field has not been modified yet."},
      {syntax: "$valid", language:"Angular", def:"Used to say that the the field content is valid."},
      {syntax: "angular.lowercase()", language:"Angular", def:"Converts a string to lowercase"},
      {syntax: "angular.uppercase()", language:"Angular", def:"Converts a string to uppercase"},
      {syntax: "angular.copy()", language:"Angular", def:"Creates a deep copy of an object or an array"},
      {syntax: "angular.forEach()", language:"Angular", def:"Executes a function for each element in an object or array"},
      {syntax: "angular.isArray()", language:"Angular", def:"Returns true if the reference is an array"},
      {syntax: "angular.isDate()", language:"Angular", def:"Returns true if the reference is a date"},
      {syntax: "angular.isDefined()", language:"Angular", def:"Returns true if the reference is defined"},
      {syntax: "angular.isElement()", language:"Angular", def:"Returns true if the reference is a DOM element"},
      {syntax: "angular.isFunction()", language:"Angular", def:"Returns true if the reference is a function"},
      {syntax: "angular.isNumber()", language:"Angular", def:"Returns true if the reference is a number"},
      {syntax: "angular.isObject()", language:"Angular", def:"Returns true if the reference is an object"},
      {syntax: "angular.isString()", language:"Angular", def:"Returns true if the reference is a string"},
      {syntax: "angular.isUndefined()", language:"Angular", def:"Returns true if the reference is undefined"},
      {syntax: "angular.equals()", language:"Angular", def:"Returns true if two references are equal"},
      {syntax: "angular.fromJSON()", language:"Angular", def:"Deserializes a JSON string"},
      {syntax: "angular.toJSON()", language:"Angular", def:"Serializes a JSON string"},
      {syntax: "angular.bootstrap()", language:"Angular", def:"Starts AngularJS manually"},
      {syntax: "angular.element()", language:"Angular", def:"Wraps an HTML element as an jQuery element"},
      {syntax: "angular.module()", language:"Angular", def:"	Creates, registers, or retrieves an AngularJS module"},
      ]
})
